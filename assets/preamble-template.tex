...
% A Part opens on a new page: its eyebrow, then the page heading at 20/24 (the .sty's \section), no bold.
\makeatletter
\renewcommand{\thepart}{\arabic{part}}
\newcommand{\hs@parteyebrow}{}
\titleclass{\part}{top}
\assignpagestyle{\part}{fancy}  % keep the head and the copyright foot on a Part page
\titleformat{\part}[display]{\fontsize{20pt}{24pt}\selectfont\color{ink}}%
